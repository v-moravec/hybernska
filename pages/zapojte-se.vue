<template>
  <div class="container mx-auto pt-10">
    ...
    <div class="p-8 mb-8 bg-black text-white rounded-3xl">
      <h2>Kdo se může zapojit do práce na projektu?</h2>
      <p class="mb-4">
        Naší snahou je propojit co nejvíce studentů z různých univerzit a fakult. Tedy i vy musíte být studentem a potvrdit (např. ISIC / studentská karta, potvrzení o studiu). Další požadavky jsou uvedeny v následujícím seznamu:
      </p>
      <ul class="mb-4">
        <li>Je nutné mít alespoň minimální znalosti svého oboru.</li>
        <li>Na projekt je důležité si umět vyhradit čas (alespoň 10 hodin v týdnu).</li>
        <li>… (TO DO)</li>
      </ul>
      <p class="mb-4">
        Pojďte s námi ukázat váš potenciál, získat další nové zkušenosti i kontakty a připsat si další řádek do vašeho CV. :)
