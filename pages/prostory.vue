<template>
  <div class="container mx-auto pt-10">
    ...
    <div class="p-6 mb-8 bg-black text-white rounded-3xl mx-auto w-fit">
      <input class="bg-white text-black rounded-full w-72 mb-4 py-2 px-4" type="date"/>
      <div class="bg-green-600 text-white py-2 px-4 w-72 max-w-full rounded-full text-center">Rezervovat</div>
    </div>
  </div>
</template>
